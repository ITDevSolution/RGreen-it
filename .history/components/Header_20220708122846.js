...
function Header() {
  ...
  return (
    <div className="sticky inset-x-0 top-0 z-50 flex items-center bg-white px-4 py-2 shadow-sm  ">
      {/* Menu mobile */}
      <div className="flex items-center justify-start lg:hidden">
        <MenuIcon className="icon" />
      </div>
      {/* logo */}
      <div className="flex grow-0 basis-1/3 h-10 w-20 flex-shrink-0 cursor-pointer mr-16 md:justify-start justify-center items-center ">
        <Link href={`/`}>
          {/* <Image
