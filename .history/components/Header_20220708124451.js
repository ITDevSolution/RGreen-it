...
function Header() {
  ...
  return (
    <div className="sticky inset-x-0 top-0 z-50 flex items-center justify-between bg-white px-4 py-2 shadow-sm  ">
      {/* logo */}
      <div className="relative h-10 w-20 flex-shrink-0 cursor-pointer mr-16 md:justify-start justify-center ">
        <Link href={`/`}>
          {/* <Image
        ...
        {/* Home */}
        <div className="hidden mx-7 md:relative md:ml-2 gap-2 items-center md:px-7">
